...
export const SingleProduct = () => {
  ...
  const getSingleProduct = () => {
    axios.get(`https://wadrobe.onrender.com/men/${id}`).then((res) => {
      setData(res.data);
...
{/*    
        { data[images].length > 0 && data[images].map((el)=>{
      ...
      <Box className="main">
        ...
        <Box className="child2">
          ...
          <Flex className="right_box_h1">
            <Text fontSize={22}>{data.brand}</Text>
          ...
          <Text fontSize={25} className="price">
            ...
            <Button marginTop={5} color={"white"} backgroundColor={"red.500"}>
