...
import { DeletePRo ,getpro} from "../../../Redux/AuthReducer/action";
export const Prorow = ({id,title,category,image,brand}) => {
  ...
  return (
    <tr>
        ...
        <td className=" py-4 whitespace-no-wrap border-b border-gray-200">
            <div className="text-sm leading-5 text-white">{category}</div>
        </td>
        <td className=" py-4 whitespace-no-wrap border-b border-gray-200">
            <div className="text-sm leading-5 text-white">{brand}</div>
        </td>

        

        <td    onClick={() => navigate(`upadte/${id}`)}
